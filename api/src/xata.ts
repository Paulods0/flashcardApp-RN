...
export type UserSet = InferredTypes["user_set"];
export type UserSetRecord = UserSet & XataRecord;
...
const defaultOptions = {
  databaseURL:
    "https://Paulo-Da-Silva-s-workspace-b7ghnd.us-west-2.xata.sh/db/flashcard-app",
};
